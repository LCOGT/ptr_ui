<template>
  <div>
    ...
    <div style="display: flex; flex-wrap: wrap">
      <div>
        ...
        <table class="info-panel-table">
          <tr>
            <td class="info-panel-val" align="right">Half-Flux Diameter:</td>
            <td>{{ brightest_hfd }}</td>
          </tr>
          <tr>
            <td class="info-panel-val" align="right">Gaussian FWHM:</td>
    ...
    <table class="info-panel-table">
      <tr>
        <td class="info-panel-val" align="right">number of stars detected:</td>
