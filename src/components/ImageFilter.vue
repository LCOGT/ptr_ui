<template>
  <div>
    ...
    >
      ...
      >
        <p> search filters </p>
        <b-icon :icon="props.open ? 'menu-down' : 'menu-left'" />
      </div>
      ...
      <div class="notification">
        <div class="content">
          ...
          <b-field label="Filter">
            ...
            >
              <option
                v-for="(filter_option, index) in filter_wheel_options"
                :key="index"
              >
                {{ filter_option[0] }}
              </option>
...
export default {
  ...
  methods: {
    ...
    onSubmit () {
      ...
      const url = this.$store.state.api_endpoints.active_api + '/filtered_images'
      const body = {
        method: 'GET',
        params: filterparams,
        // baseURL: apiName,
