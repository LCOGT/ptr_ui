...
const makeIcon = (function () {
    ...
    var nameTemplate = processTemplate('<text x="50%" y="35%" font-size="6" font-weight="bold" font-family="Verdana" fill="white" text-anchor="middle" dominant-baseline="middle" lenghtAdjust1="spacingAndGlyphs" textLength1="15">`name`</text>')
    ...
    return function (fill, stroke, plus, name) {
        var svg = applyTemplate(svgTemplate, {
            ...
            name: name ? applyTemplate(nameTemplate, { name: name}) : '',
        });
