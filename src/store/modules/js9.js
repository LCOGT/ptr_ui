...
const actions = {
    ...
    async resizeForCrosshairs({dispatch, state}) {
        ...
        let imageWindow, withCrosshairs, noCrosshairs;

        // Calculate the size we would need for resizing with and without the crosshair plots
        withCrosshairs = document.getElementById("js9analysiswrapper").getBoundingClientRect()
        noCrosshairs = document.getElementsByClassName("js9-grid")[0].getBoundingClientRect()
