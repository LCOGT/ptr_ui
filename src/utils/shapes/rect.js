...
class Rect extends BaseShape {
  ...
  draw () {
    ...
    const g = this.svg.selectAll('.custom-rect')
      .data(this.data)
      .join('g')
    ...
    // drag handle 1 area
    g.selectAll('.drag-handle-1-area')
      .data(d => [d])
      .join('circle')
    ...
    // drag handle 2 area
    g.selectAll('.drag-handle-2-area')
      .data(d => [d])
      .join('circle')
    ...
    // drag handle 3 area
    g.selectAll('.drag-handle-3-area')
      .data(d => [d])
      .join('circle')
    ...
    // drag handle 4 area
    g.selectAll('.drag-handle-4-area')
      .data(d => [d])
      .join('circle')
