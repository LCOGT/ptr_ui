...
wcs.pix2wcs = function(x,y) {
    ...
    ra = this.crval[0] + (a * this.CD[1][1]) + (b * this.CD[1][2])
    dec = this.crval[1] + (a * this.CD[2][1]) + (b * this.CD[2][2])
...
wcs.CD = [[],[],[]]
wcs.CD[1][1] = parseFloat('-1.19972030202E-05')
wcs.CD[1][2] = parseFloat('-0.000761947551202')
wcs.CD[2][1] = parseFloat('0.000761749736952')
wcs.CD[2][2] = parseFloat('-1.20574437687E-05') 
...
//wcs.file = API.post('LambdaTest', '/getFits').then(response => {
//    console.log('fits data: ')
//    console.log(response.image_url)
//})

wcs.simplefitsreader = function(fits_file) {
